;; Route Bulletproof Generator
;; A smart contract for creating, minting and trading unique route-based geometric patterns as NFTs on the Stacks blockchain.
;; This contract handles the complete lifecycle of route NFTs, stores generation parameters on-chain,
;; and ensures verifiable uniqueness while managing ownership and royalties.
